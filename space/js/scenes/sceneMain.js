class SceneMain extends Phaser.Scene {
    ...
    create() {
       ...
       this.canterX=game.config.width/2;
       this.canterY=game.config.height/2;

       this.background=this.add.image(0,0,'background');
       this.background.setOrigin(0,0);
       this.ship=this.physics.add.sprite(this.canterX,this.canterY,'ship');
       ...
       this.physics.world.setBounds(0,0,this.background.displayHeight,this.background.displayHeight);
    ...
    this.eship=this.physics.add.sprite(this.canterX,0,'eship');
  ...
  this.rockGroup= this.physics.add.group({
    ...
    makeBullet(){
        ...
        var bullet = this.physics.add.sprite(this.ship.x+dirObj.tx*30,this.ship.y,'bullet');
        this.bulletGroup.add(bullet);
        bullet.angle=this.ship.angle;
        bullet.body.setVelocity(dirObj.tx*200,dirObj.ty*100);
